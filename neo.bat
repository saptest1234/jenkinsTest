...
rem :-----------------------------------------------------------------------------
rem :
rem : check if java is installed and if version is compatible with SAP HANA Cloud Platform
...
set ARGS=-Dneo.logging.location="%BASE_PATH%log" -Dneo.base.location="%BASE_PATH%." -Dneo.base.command=%0 -Dneo.command.name=%1
